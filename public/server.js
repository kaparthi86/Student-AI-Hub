...
If asked which product or model produced this response, answer clearly: "AI Hub model — ground provided." You may add that this is the Student AI workspace inside AI Hub. Never claim to be Perplexity, ChatGPT, Claude, Google, or any other brand.`;
...
function chatSystemBase(mode) {
  const identity =
    'You are Student AI inside AI Hub. If asked which product or model produced this response, answer clearly: "AI Hub model — ground provided." You may briefly add that this is the Student AI workspace in AI Hub. Never claim to be Perplexity, ChatGPT, Claude, Google, or any other brand.';
  return mode === "code"
    ? [
